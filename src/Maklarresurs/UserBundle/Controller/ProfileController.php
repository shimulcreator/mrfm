...
//        $form->add('submit', 'submit', array('label' => 'Update'));
     ...
     *
     * @Route("/update", name="user_profile_update")
     * @Method("PUT")
    ...
    {
        return $this->render('MaklarresursUserBundle:Profile:changePassword.html.twig');
    }
    ...
    public function updatePasswordAction(Request $request){
        ...
        return $this->redirect($this->generateUrl('user_change_password'));
    }
     ...
     *
     * @Route("/create/uploads", name="avater_img_uploads")
     * @Method("GET")
     * @Template()
     */
    public function imgUploadsAction()
    {
        ...
        return $this->render('MaklarresursUserBundle:Profile:img.html.twig', array(
            'entity' => $entity,
            'avatars'  => $avatars,
     ...
     *
     * @return array
     * @Route("/create/img", name="avatar_img_uploads_create")
     * @Method("POST")
     * @Template()
     */
    public function createImgAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('avater_img_uploads', array('id' => $user->getId())));
