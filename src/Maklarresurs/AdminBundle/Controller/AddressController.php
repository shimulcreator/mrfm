...
use Maklarresurs\AdminBundle\Form\AddressType;
...
class AddressController extends BaseController
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('MaklarresursAppBundle:Address')->findAll();
     ...
     * @Method("POST")
     * @Template("MaklarresursAdminBundle:Address:new.html.twig")
     */
...
//        $form->add('submit', 'submit', array('label' => 'Update'));
     ...
     * @Method("PUT")
     * @Template("MaklarresursAdminBundle:Address:edit.html.twig")
     */
