...
class ProfileController extends BaseController
{
     ...
     *
     * @Route("/edit", name="supplier_profile_edit")
     * @Method("GET")
     * @Template()
     */
    ...
    private function createEditForm(User $entity)
    {
        $form = $this->createForm(new ProfileType(), $entity, array(
            'action' => $this->generateUrl('supplier_profile_update'),
            'method' => 'PUT',
        ));
...
//        $form->add('submit', 'submit', array('label' => 'Update'));
     ...
     *
     * @Route("/update", name="supplier_profile_update")
     * @Method("PUT")
     * @Template("MaklarresursUserBundle:Profile:edit.html.twig")
     */
    public function updateAction(Request $request)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('supplier_profile'));
        }
    ...
    /**
     * @Route("/change-password", name="supplier_change_password")
     * @Template()
     */
    public function changePasswordAction()
    {
        return $this->render('MaklarresursSupplierBundle:Profile:changePassword.html.twig');
    }

    /**
     * Changes user password
     *
     * @Route("/update-password", name="supplier_update_password")
     */
    public function updatePasswordAction(Request $request){
        ...
        return $this->redirect($this->generateUrl('supplier_change_password'));
    }
     ...
     *
     * @Route("/create/uploads", name="supplier_avater_img_uploads")
     * @Method("GET")
     * @Template()
     */
    public function imgUploadsAction()
    {
        ...
        return $this->render('MaklarresursSupplierBundle:Profile:img.html.twig', array(
            'entity' => $entity,
            'avatars'  => $avatars,
     ...
     *
     * @return array
     * @Route("/create/img", name="supplier_avatar_img_uploads_create")
     * @Method("POST")
     * @Template()
     */
    public function createImgAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('supplier_avater_img_uploads', array('id' => $user->getId())));
